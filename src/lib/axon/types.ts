...
export interface Lead {
  ...
  created_at: string;
  /** NI-OUTREACH-ARTIFACT-GAP-0914 (Decision #1888): the generated deliverable
   * artifact link — for NI Services (source=axon_ni_services) leads with no
   * existing website, the individualized interactive HTML site preview. Null
   * until generated by ensureNiServicesArtifact(); always null for lead types
   * with no artifact deliverable (e.g. Match Fit). */
