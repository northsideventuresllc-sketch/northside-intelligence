...
| **TikTok carousel** | **MANUAL PACK TO JB — the only route, on every date** | JB's travel hold (live rules preflight §13) ran **to 2026-08-03** and closes on its own terms; before that date do not attempt, queue or raise it. **DEAD ROUTE — the Android emulator** (Decision #486, 2026-07-31: `adb` not found, all emulator ports refused under a control, heartbeat empty). Earlier wording here offered it as a route — do not reinstate. TikTok web has **no photo-mode path** (Decision #482). This is where the automated attempt **STOPS**. **TikTok video is unaffected.** **Never substitute a slideshow video.** |
